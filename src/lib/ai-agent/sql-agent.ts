...
- When asked for a rapport/report/PDF, structure your answer as a full markdown report with # headers and sections.
- Always suggest 2-3 follow-up questions the user might find useful.
`
